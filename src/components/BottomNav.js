    ...
    >
      ...
      {mobileDimension && (
        ...
        >
          ...
          <span style={{ fontSize: currentPage === "profile" ? "8px" : "8px", marginTop: "4px" }}>{t("profile")}</span>
        ...
        >
          ...
          <span style={{ fontSize: currentPage === "home" ? "8px" : "8px", marginTop: "4px"  }}>{t("home")}</span>
        ...
        >
          ...
          <span style={{ fontSize: currentPage === "saved" ? "8px" : "8px", }}>{t('saved')}</span>
...
// Helper component for consistent icon alignment
const NavIconWrapper = ({ children }) => (
